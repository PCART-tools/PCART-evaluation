...
outputs = model.forward(input_ids, attention_mask, token_type_ids, position_ids, head_mask=None, inputs_embeds=None, labels=masked_lm_labels, output_attentions=None, output_hidden_states=None)
