...
outputs = model.forward(input_ids, attention_mask, token_type_ids, position_ids, head_mask=None, inputs_embeds=None, output_attentions=None, output_hidden_states=None)
