...
outputs = model.forward(input_ids, attention_mask, token_type_ids, position_ids, None, None, masked_lm_labels, sentence_order_label, output_attentions=None, output_hidden_states=None)
